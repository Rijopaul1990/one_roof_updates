                        ...
                        <div class="card bg-authentication mb-0">
                            <div class="row m-0">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form action="<?php echo base_url(); ?>login" method="post">
                                                    <div class="form-group mb-50">
                                                        ...
                                                        <input type="text" name="user_name" class="form-control" placeholder="User Name"></div>
                                ...
                                <div class="col-md-6 d-md-block d-none text-center align-self-center p-3">
                                    <div class="card-content">
                                        <img class="img-fluid" src="<?php echo base_url();?>assets/images/login.png" alt="branding logo">
                                    </div>
                                </div>
                            </div>
                        </div>
